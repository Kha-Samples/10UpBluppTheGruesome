...
class TenUp5 extends Game {
	public static var the(default, null): TenUp5;
	...
	@:access(sprites.Player) @:access(dialogue.BlaBox) 
	private function drawPlayerInfo(g: Graphics): Void {
		var x = 30;
		var y = height - 85;
		g.color = Color.fromBytes(40, 40, 40);
		g.fillRect(x-10, y-30, TenUp5.the.width - 2 * (x-10), 90);
		g.color = Color.White;
